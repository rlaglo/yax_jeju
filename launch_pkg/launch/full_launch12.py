...
def generate_launch_description():
    ...
    front_camera_node = Node(
        ...
        name='front_camera',
        parameters=[{'cam_num': 0}], # /dev/video0 가정
    ...
    left_camera_node = Node(
        ...
        executable='image_publisher_node',
        name='left_camera',
        parameters=[{'cam_num': 2}], # /dev/video2 가정
    ...
    right_camera_node = Node(
        ...
        executable='image_publisher_node',
        name='right_camera',
        parameters=[{'cam_num': 4}], # /dev/video4 가정
    ...
    left_object_detector = Node(
        package='camera_perception_pkg', executable='object_detector_node',
        name='left_object_detector', parameters=[{'camera_position': 'left'}]
    )
    right_object_detector = Node(
        package='camera_perception_pkg', executable='object_detector_node',
        name='right_object_detector', parameters=[{'camera_position': 'right'}]
    )
    ...
    return LaunchDescription([
        ...
        # 카메라 인식 관련
        front_camera_node, left_camera_node, right_camera_node,
        yolov8_node,
        traffic_light_detector_node,
        left_object_detector, right_object_detector,
