...
class Yolov8TrafficLightNode(LifecycleNode):

    def __init__(self, **kwargs) -> None:
        super().__init__("yolov8_traffic_light_node", **kwargs)
        ...
        self.get_logger().info('Yolov8TrafficLightNode created')
    ...
    def on_configure(self, state: LifecycleState) -> TransitionCallbackReturn:
        ...
        self._pub = self.create_lifecycle_publisher(
            DetectionArray, "traffic_light_detections", 10) # Changed topic
